...
$text = "<span style='color:cyan; font-size: 35px; line-height: 40px; magin: 10px;'>Error! Please try again.</span>";
...
if(isset($_POST['submitcontact']))
{
	...
	$subject = "LittleFox - Testing Contact Form";
	$message = " Name: " . $name ."\r\n Email: " . $email . "\r\n Message:\r\n" . $message;
	 
	$from = "LittleFox dot com";
	$headers = "From:" . $from . "\r\n";
			...
			<div class="top-header">
				<div class="zerogrid">
					<div class="row">
						<div class="col-1-3">
							<div class="wrap-col">
								<span><i class="fa fa-map-marker"></i> <strong>9876 Canada THK</strong>, Greenlade, CA</span>
							</div>
						</div>
						<div class="col-1-3">
							<div class="wrap-col">
